...
$app-> post("/profile", function(){
	...
	User::getSuccess("Os seus dados foram atualizados com sucesso!");
...
$app-> get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja WPL Store";
	$dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
	$dadosboleto["demonstrativo3"] = "";
	$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
	$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
	$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: suporte@hcode.com.br";
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Loja WPL Store E-commerce - www.wplstore.com";
	...
	$dadosboleto["agencia"] = "0001"; // Num da agencia, sem digito
	$dadosboleto["conta"] = "6617167";	// Num da conta, sem digito
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "WPL Store";
	$dadosboleto["cpf_cnpj"] = "127.425.494-98";
	$dadosboleto["endereco"] = "Rua Rosemiro Fontes Carneiro, 46 - Rincão, 59626-250";
	$dadosboleto["cidade_uf"] = "Mossoró - RN";
	$dadosboleto["cedente"] = "WPL CORP LTDA - ME";
...
$app-> post("/profile/change-password",function(){
	...
	// $hash = User::getPasswordHash(1234);
	// var_dump($hash);
	// exit;
